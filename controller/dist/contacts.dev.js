    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return regeneratorRuntime.awrap(getAllContacts({
            page: page,
            limit: limit,
            favorite: favorite
          }));
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return regeneratorRuntime.awrap(getContactById(req.params.contactId));
  ...
  return regeneratorRuntime.async(function create$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 5:
          _context3.next = 7;
          return regeneratorRuntime.awrap(createContact(value));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 5:
          ...
          _context5.next = 8;
          return regeneratorRuntime.awrap(getContactById(contactId));
        ...
        case 12:
          ...
          res.status(200).json(_objectSpread({}, updatedContact._doc, {}, value));
          _context5.next = 17;
          break;
...
function updateOne(req, res) {
  var _validFavoriteField, isValid, favorite, message, contactId, contactsById;
  ...
  return regeneratorRuntime.async(function updateOne$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 8:
          contactsById = _context6.sent;
          _context6.next = 11;
          return regeneratorRuntime.awrap(updateStatusContact(contactId, favorite));

        case 11:
          res.status(200).json(_objectSpread({}, contactsById._doc, {
            favorite: favorite
          }));
          _context6.next = 18;
          break;
